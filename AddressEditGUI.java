...
public class AddressEditGUI extends JFrame{
    
   private JPanel contentPane;
	private JTextField textField;
public AddressEditGUI(int id){
   setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		JLabel lblEnterNewAge = new JLabel("Enter New Age");
		lblEnterNewAge.setFont(new Font("Tahoma", Font.BOLD, 24));
		lblEnterNewAge.setBounds(283, 131, 365, 38);
